...
export default function Hero() {
  ...
  return (
    <section className="container flex items-center justify-start min-h[90vh] py-40 md:py64 mx-auto text-white">
      <motion.div
        initial="hidden"
        animate={hasAnimated ? "visible" : "hidden"}
        variants={containerVariants}
      ...
      >
          ...
          {[
            {
              ...
              link: "https://github.com/dhruvvaghani66?tab=repositories",
            },
            {
              icon: <FaLinkedinIn size={26} />,
              link: "https://www.linkedin.com/in/dhruv-vaghani-745222219/",
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-col gap-4 mt-12 sm:flex-row sm:items-center sm:gap-6"
        >
          {/* Primary */}
          <motion.a
            ...
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center justify-center w-full h-12 px-8 text-sm font-semibold text-black transition-colors duration-300 ease-in-out bg-white rounded-full sm:w-auto hover:bg-green-500/90 hover:text-white"
          >
            Download Resume
          </motion.a>
          ...
          <motion.a
            ...
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center justify-center w-full h-12 px-8 text-sm font-semibold text-white transition-colors duration-300 ease-in-out border rounded-full sm:w-auto border-white/40 hover:bg-white hover:text-black"
          >
            View Projects
          </motion.a>
        </motion.div>
